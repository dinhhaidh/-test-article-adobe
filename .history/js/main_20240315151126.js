...
gsap.from('.home__img', 2.3, {opacity: 0, x: 100, delay: 1.2})
gsap.from('.building__title', 2.3, {opacity: 0, x: -100, delay: 2.2})
gsap.from('.building__description', 2.3, {opacity: 0, x: -100, delay: 2.5})
gsap.from('.building__content ', 2.3, {opacity: 0, x: -100, delay: 2.8})
gsap.from('.building__images ', 2.3, {opacity: 0, x: -100, delay: 2.5})
...
sr.reveal(`.about__image, .digtal__swipper `) //hiệu ứng trên xuống
sr.reveal(`.about__data`,{origin: 'bottom'})
sr.reveal(`.blog__data`,{origin: 'top'})
sr.reveal(`.blog__image`,{origin: 'bottom'})
sr.reveal(`.challenges`,{interval: 100}) //hiệu ứng trêm xuống lần lần từng giây
