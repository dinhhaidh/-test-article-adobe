...
sr.reveal(`.building__data`,{origin: 'right'})
sr.reveal(`.building__images`,{origin: 'left'})
sr.reveal(`.challenges, .card__container `,{interval: 100}) //hiệu ứng trêm xuống lần lần từng giây
