...
sr.reveal(`.about__data,.blog__image, .touch__data, .footer__container`,{origin: 'bottom'})
sr.reveal(`.blog__data, .different__container`,{origin: 'top'})
sr.reveal(`.building__data, .card__content`,{origin: 'right'})
sr.reveal(`.building__images, .card__data`,{origin: 'left'})
